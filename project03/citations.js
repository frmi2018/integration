...
let dernier = 0; // citation actuellement affichée
...
nouveau.addEventListener('click', () => {
	// cherche une citation tant que non différente de celle affichée 
	do {
		var nombreAleatoire = genererNombreEntier(citations.length);
